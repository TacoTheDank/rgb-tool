...
public class RGBToolPrintColorDetailsAdapter extends PrintDocumentAdapter {
    ...
    private void drawPage(PdfDocument.Page page) {
        ...
        canvas.drawRect(leftMargin,
                itemYCoordinate + 20,
                leftMargin + 50,
                itemYCoordinate + 70, paint);

        itemYCoordinate += 110;
        // Complementary
        paint.setColor(Color.BLACK);
        paint.setTextSize(16);
        canvas.drawText(context.getString(R.string.color_details_complementary,
                ColorUtils.RGBToHex(complementaryColor)), leftMargin,
                itemYCoordinate,
                paint);
        ...
        paint.setColor(Color.BLACK);
        paint.setTextSize(16);
        canvas.drawText(context.getString(R.string.color_details_contrast,
                ColorUtils.RGBToHex(contrastColor)),
                leftMargin,
                itemYCoordinate, paint);
